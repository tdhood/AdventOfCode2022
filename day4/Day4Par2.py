...
def compare_sections(sections):
    ...
    for section in sections:
        ...
        if section_1_start >= section_2_start and section_1_start < section_2_end:
            count +=  1
            print('counted')
        elif section_2_start >= section_1_start and section_2_start < section_1_end:
            count += 1
            print('counted')
        elif section_1_end <= section_2_end and section_2_start <= section_1_end:
            count += 1
            print('counted')
        elif section_2_end <= section_1_end and section_1_start <= section_2_end:
            count += 1
            print('counted')
